...
<body>
        ...
        <div class="nav-buttons">
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a href="#" class="language-option">Hindi</a>
                    <a href="#" class="language-option">Marathi</a>
                </div>
            </div>
            <a href="login.php"><button class="btn btn-red-sm">Sign In</button></a>
        </div>
      </nav>
        <div class="box">
        </div>
    ...
    <section class="faq">
        ...
        <div class="faq-info">
          <p>Netflix is a streaming service that offers a wide variety of TV shows, movies, anime, documentaries, and more on thousands of internet-connected devices. You can watch as much as you want, whenever you want, without a single commercial – all for one low monthly price.</p>
        </div>
        <div class="faqbox">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    faqBoxes.forEach(function(box) {
        box.addEventListener('click', function() {
            ...
            const faqInfo = box.nextElementSibling;
            faqInfo.classList.toggle('active');
        });
    });
});
